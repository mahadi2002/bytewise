 ...
 *
 * Shared-hosting fallback: if public/ cannot be the docroot, copy its
 * contents into public_html/ and point APP_ROOT at the app folder:
 *   define('APP_ROOT', '/home/USER/bytewise');
 */
