...
final class RemoteJudgeGateway implements CodeExecutionGateway
{
    ...
    public function submit(
        ...
        throw new \RuntimeException('RemoteJudgeGateway::submit is a stub — BLOCKER-2 must be resolved first.');
    }

    public function checkStatus(string $externalSubmissionRef): ExecutionStatusResult
    {
        throw new \RuntimeException('RemoteJudgeGateway::checkStatus is a stub — BLOCKER-2 must be resolved first.');
    }
}
