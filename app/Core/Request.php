...
final class Request
{
    ...
    public static function capture(): self
    {
        ...
        $body = $_POST;
        if ($method !== 'GET' && str_starts_with((string) ($_SERVER['CONTENT_TYPE'] ?? ''), 'application/json')) {
    ...
    /**
     * Client IP. Only trusts X-Forwarded-For when the immediate peer is a
     * trusted proxy — otherwise it's trivially spoofed, which would defeat
